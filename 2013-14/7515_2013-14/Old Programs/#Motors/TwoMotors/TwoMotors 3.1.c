...
#pragma config(Servo,  mtr_S1_C2_1,    left,               tServoStandard)
#pragma config(Servo,  mtr_S1_C2_2,    bleft,               tServoNone)
#pragma config(Servo,  mtr_S1_C2_3,    conv,               tServoNone)
#pragma config(Servo,  mtr_S1_C2_4,    flag,               tServoNone)
