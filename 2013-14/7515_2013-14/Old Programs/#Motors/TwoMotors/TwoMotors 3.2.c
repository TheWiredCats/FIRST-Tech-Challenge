...
#pragma config(Motor,  mtr_S1_C1_1,     conv,          tmotorTetrix, PIDControl, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     flag,          tmotorTetrix, PIDControl, encoder)
...
#pragma config(Servo,  srvo_S1_C4_2,    lservo,               tServoStandard)
